...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_c,      spawn,          SHCMD("firefox canvas.uncc.edu") },
	{ MODKEY|ShiftMask,             XK_y,      spawn,          SHCMD("firefox youtube.com") },
	{ MODKEY|ShiftMask,             XK_F2,     spawn,          SHCMD("firefox twitch.tv") },
